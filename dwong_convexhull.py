...
def clus_coord(file):
    ...
    for i in range(len(labels)):#loop through evts
        ...
        for item in labels_decrease[i]:
            ...
            evt_wew_center.append((np.dot(xvals, energies)/eng_tot, np.dot(yvals, energies)/eng_tot)) #center for each cluster
